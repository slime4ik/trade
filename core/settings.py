...
SECRET_KEY = 'django-insecure-zq&2nedbtz$=74c0a=9g-tc5joy4*3e%ikbv-@yi&4om=od1m7'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'ad.context_proccesors.search_form' # Для передачи формы поиска в шаблоны {{search_form}}
            ],
        },
    },
]
